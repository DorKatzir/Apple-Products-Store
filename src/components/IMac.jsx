  ...
  return (
    <div className='h-full grid grid-cols-2 grid-rows-2 md:gap-4 gap-1 bg-white relative'>
        ...
        <div className='bg-gray-50 col-span-1 row-span-1 flex items-center justify-center'>
            <img src={ getCurrentModel().images.front } alt="IMac" className='2xl:max-w-full xl:max-w-52 max-w-48'/>
        </div>

        <div className='bg-gray-50 col-span-1 row-span-1 flex items-center justify-center'>
            <img src={ getCurrentModel().images.back } alt="IMac" className='2xl:max-w-full xl:max-w-52 max-w-48'/>
        </div>
