  ...
  return (
    <div className='h-full grid grid-cols-2 grid-rows-2 md:gap-4 gap-1 bg-white relative'>
        ...
        <div className='h-full col-span-1 row-span-2 flex flex-col items-center md:justify-center justify-start pt-8 bg-gray-50'>
            <img src="images/imac/green-side.jpg" alt="IMac" className='2xl:max-w-full xl:max-w-36 max-w-24'/>
        </div>

        <div className='bg-gray-50 col-span-1 row-span-1 flex items-center justify-center'>
            <img src="images/imac/green-front.jpg" alt="IMac" className='2xl:max-w-full xl:max-w-52 max-w-48'/>
        </div>

        <div className='bg-gray-50 col-span-1 row-span-1 flex items-center justify-center'>
            <img src="images/imac/green-back.jpg" alt="IMac" className='2xl:max-w-full xl:max-w-52 max-w-48'/>
        </div>
        ...
        <div className='absolute md:top-1/2 top-3/4 md:left-4 left-12 transform -translate-y-1/2 flex flex-col lg:space-y-2 space-y-1 bg-gray-50'>
            ...
            <button type="button" className='text-sm mt-4 w-min py-1 px-3 bg-blue-400 rounded-full text-white'>Shop</button>
