...
export const macbookModels = [
  {
    ...
    colors: [
      { label: 'Space gray', bg: 'bg-[#b2b5b8]', img: 'images/macbook-air-spacegray-m2.jpg' },
      { label: 'Gold', bg: 'bg-[#f0e0d3]', img: 'images/macbook-air-gold-m2.jpg' },
      { label: 'Silver', bg: 'bg-[#e0e2e1]', img: 'images/macbook-air-silver-m2.jpg' },
    ],
  ...
  },
  {
    ...
    colors: [
      { label: 'Midnight', bg: 'bg-[#2e3641]', img: 'images/macbook-air-midnight-m3.jpg' },
      { label: 'Starlight', bg: 'bg-[#f0e5d3]', img: 'images/macbook-air-starlight-m3.jpg' },
      { label: 'Space gray', bg: 'bg-[#7d7e80]', img: 'images/macbook-air-spacegray-m3.jpg' },
      { label: 'Silver', bg: 'bg-[#e3e4e6]', img: 'images/macbook-air-silver-m3.jpg' },
    ],
